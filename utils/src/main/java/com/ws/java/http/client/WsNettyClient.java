...
import com.ws.java.common.WsImageUtils;
import com.ws.java.http.client.handler.NettyHttpClientResponseHandler;
import com.ws.java.http.client.initializer.HttpInitializer;
import com.ws.java.http.client.model.HttpRequestBody;
import com.ws.java.http.client.model.HttpResponseBody;
import com.ws.java.http.client.model.HttpResponseTask;
import com.ws.java.http.client.processor.WsChannelHttpRequestBodyBind;
import com.ws.java.http.client.utils.WsNettyClientUtils;
...
public class WsNettyClient {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 1; i++) {
            ...
            httpRequestBody.setUrl("https://www.bilibili.com/blackroom/")
                    .setMethod("GET")
                    .setGZIP(true)
                    .setUseChunked(true);
                ...
                try {
                    ...
                    if (httpResponseBody != null){
                        ...
                        if(httpResponseBody.getCode()==200){
                            ...
                            WsImageUtils.byteToFile(httpResponseBody.getReturnBytes(),httpRequestBody.getUri().getHost()+ i1,"txt","F:/网页/");
                        }else {
                            WsImageUtils.byteToFile(httpResponseBody.getErrorReturnBytes(),httpRequestBody.getUri().getHost()+ i1,"txt","F:/网页/");
                        }
