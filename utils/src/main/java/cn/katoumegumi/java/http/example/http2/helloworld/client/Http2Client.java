 ...
 * the License.
 */
package cn.katoumegumi.java.http.example.http2.helloworld.client;
...
public final class Http2Client {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            URI uri = new URI("http://localhost:1996");
            Bootstrap b = new Bootstrap();
            b.group(workerGroup);
            b.channel(NioSocketChannel.class);
            b.option(ChannelOption.SO_KEEPALIVE, true);
            b.remoteAddress(uri.getHost(), 1996);
            ...
            int streamId = 3;
            HttpScheme scheme = false ? HttpScheme.HTTPS : HttpScheme.HTTP;
            AsciiString hostName = new AsciiString(uri.getHost() + ':' + uri.getPort());
