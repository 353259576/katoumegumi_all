...
import com.ws.java.common.WsBeanUtis;
import com.ws.java.common.WsDateUtils;
                        ...
                        try {
                            ...
                            if(mySearchFieldName.contains(".")){
                                ...
                                for (;i < fieldPaths.length - 1; i++){
                                    if(join == null){
                                        join = root.join(fieldPaths[i]);
                                    }else {
                                        join = join.join(fieldPaths[i]);
                                    }
                                }
                                path = join.get(fieldPaths[i]);
                            }else {
